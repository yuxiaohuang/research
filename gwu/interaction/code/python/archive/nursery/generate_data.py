...
name_L = ['parents', 'has_nurs', 'form', 'children', 'housing', 'finance', 'social', 'health', 'class']

# The list of value of variables
val_str_L = ['usual, pretentious, great_pret', 'proper, less_proper, improper, critical, very_crit', 'complete, completed, incomplete, foster', '1, 2, 3, more', 'convenient, less_conv, critical', 'convenient, inconv', 'non-prob, slightly_prob, problematic', 'recommended, priority, not_recom', 'not_recom, recommend, very_recom, priority, spec_prior']
