...
def generate_data():
    ...
    for i in range(0, max_time_stamp):
        ...
        class_val = spamreader[i][10].strip()
    ...
    with open(src_data_training_file, 'w') as f:
        ...
        for i in range(100):
            # Write the value
            for time in range(0, int(0.8 * max_time_stamp)):
    ...
    with open(src_data_testing_file, 'w') as f:
        ...
        # Write the value
        for time in range(int(0.8 * max_time_stamp), max_time_stamp + 1):
            # The list of value at the time
            val_L = []
